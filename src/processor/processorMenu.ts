...
export default class ProcessorMenu extends MenuBase {
    ...
    createCoresUsagePopup(sourceActor: St.Widget) {
        ...
        if(numCores >= 10) defaultStyle = 'width: 3.6em;';
        if(numCores >= 100) defaultStyle = 'width: 4.0em;';
    ...
    override destroy() {
        ...
        this.processorBar = undefined as any;

        this.graph?.destroy();
        this.graph = undefined as any;

        this.cpuInfoPopup?.destroy();
        this.cpuInfoPopup = undefined as any;
        ...
        this.cpuCategoryUsagePopup = undefined as any;
