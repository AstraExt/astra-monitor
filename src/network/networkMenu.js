...
export class NetworkMenu extends MenuBase {
    constructor(sourceActor, arrowAlignment, arrowSide) {
        ...
        this.networkSectionLabel = this.addMenuSection(_('Network'), 'centered');
    ...
    createDeviceList() {
        if(this.deviceSection === undefined) {
            this.deviceSectionLabel = this.addMenuSection(_('Interfaces'), 'centered');
    ...
    updateInterfaceDevice(device, deviceData) {
    ...
    update(code) {
        ...
        if(code === 'detailedNetworkIO') {
            let current = Utils.networkMonitor.getCurrentValue('detailedNetworkIO');
